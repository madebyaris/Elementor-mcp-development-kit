...
Find and replace the `madebyaris-mcp-elementor` namespace and `example.com` string with your own organization
...
throughout the codebase where `madebyaris-mcp-elementor` is used.
